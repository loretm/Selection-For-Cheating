...
<h2>3.The TC attempted to account for uneven sampling by randomly sub-sampling the dataset to equalize sampling effort among populations</h2> 
...
<h2> 4.Comparing sampled-based and individual-based approaches </h2>
