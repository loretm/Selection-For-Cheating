...
- Let's define $$y_{XA}$$ as the haplotype frequency of isolate X in Population A

$$y_{XA} = count of isolate X / count of all isolates in population A$$
$$y_{XA} = X_{i}/X_{A}$$

- Let's define $$Y_{A}$$ as the mean strain frequency in Population A, estimated as the sum of the haplotype frequencies of all isolates found in population A divided by the count of all isolates in population A

$$Y_{A} = (\sum_{i=1}^XX_{i}/X_{A})/X_{A}$$
...
$$y_{XA} = [ X_{i}/X_{A}]/Y_{A} = [ X_{i}/X_{A}]/[(\sum_{i=1}^XX_{i}/X_{A})/X_{A}]$$
